...
app.get('/login', async (req, res) => {
    ...
    console.log('req: ', req.protocol, req.hostname, req.baseUrl, req.url, req.originalUrl, req.path, req.query);

    const redirect_url = new URL("https" + '://' + "openai.ki.fh-swf.de" + "/api" + '/callback');
...
app.get('/callback', async (req, res) => {
    ...
    const redirect_url = new URL("https" + '://' + "openai.ki.fh-swf.de");
